...
$i18n = array(
    'GO' => "Hľadať"
  , 'HEADER' => "Výsledky vyhľadávania"
  , 'NOT_FOUND' => "Žiadne výsledky"
  , 'DATE_LOCALE' => "sk_SK.utf8,sk_Sk,sk"
  ...
  , 'CONFIGURE' => "Nastaviť vyhľadávanie"
  , 'CONFIGURATION' => "Vyhľadávanie - I18N Search"
  , 'VIEW_USAGE' => "Použitie"
  , 'VIEW_SETTINGS' => "Nastavenia"
  , 'INDEX_SETTINGS' => "Nastavenie Indexovania"
  , 'INDEX_DESCRIPTION' => "Toto nastavenie popisuje dôležitosť slova od toho, kde sa nachádza. Napr. Ak dôležitosť obsahu je 1 a dôležitosť nadpisu je 5, znamená to, že nájsť slovo jeden krát v názve je dôležitejšie ako nájsť ho 4 krát v obsahu."
  , 'CONTENT_WEIGHT' => "Relatívna dôležitosť obsahu"
  , 'TITLE_WEIGHT' => "Relatívna dôležitosť názvu"
  , 'TAG_WEIGHT' => "Relatívna dôležitosť menovky (tag)"
  , 'SEARCHFORM_SETTINGS' => "Nastavenie vyhľadávacieho formulára"
  ...
  , 'SAVE_CONFIGURATION' => "Uložiť Nastavenie Vyhľadávania"
  , 'RESET_CONFIGURATION' => "Vynulovať Nastavenie Vyhľadávania"
